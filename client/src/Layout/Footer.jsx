    ...
    <div className={classes.footer}>
      <div className={classes.footer__text}>
        ...
        <div className={classes.footer__text__info}>
          <p>
            <span>
              <strong>· 백엔드 개발 &nbsp;&nbsp;</strong>김영애
            </span>
          </p>
          <p>
            <span>
              <strong>· 백엔드 개발 &nbsp;&nbsp;</strong>김종원
            </span>
          </p>
          <p>
            <span>
              <strong>· 프론트엔드 개발 &nbsp;&nbsp;</strong>양지현
            </span>
          </p>
          <p>
            <span>
              <strong>· 프론트엔드 개발 &nbsp;&nbsp;</strong>이동빈
            </span>
          </p>
          <p>
            <span>
              <strong>· 이메일 &nbsp;&nbsp;</strong>meditime@example.com&nbsp;
            </span>
          </p>
          <p>
            <span>
              <strong>· 고객지원 &nbsp;&nbsp;</strong>오전 10시 ~ 오후 5시 (주말
              및 공휴일 제외)
            </span>
          </p>
        </div>
