...
export default function BoarderRegisterForm({ onRegister }) {
    ...
    return (
        <div align="center">
            ...
            <h2 className={classes.title2}>주의❗ &nbsp; 현재 회원님의 약상자에 담겨 있는 복약 정보가 글과 함께 보여지게 됩니다.</h2>
            <form onSubmit={handleSubmit}>
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input className={classes.file} type="file" onChange={handleChangeFile} />
                            </td>
                        </tr>
                        <tr>
                ...
                <div>
                    ...
                    <Link to="/medipeople" className="like-a-button">취소</Link>                     
                </div>
            </form>
        </div>
    )
