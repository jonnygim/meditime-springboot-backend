        ...
        <ul>
          <li>
            <label htmlFor="UserId" onChange={this.handleSignUpValue("userId")}>
              ...
              <input
                type="userId"
                onBlur={this.handleIdValue("userId")}
              ></input>
          ...
          <li>
            <label htmlFor="email">
              ...
              <input
                id="email"
                type="email"
                onChange={this.handleSignUpValue("email")}
              ></input>
          ...
          <li>
            <label htmlFor="password">
              ...
              <input
                type="password"
                onChange={this.handleSignUpValue("password")}
              ></input>
          ...
          <li>
            <label
              ...
              onChange={this.handleSignUpValue("passwordCheck")}
            >
              <div>비밀번호 확인</div>
          ...
          <li>
            <label
              htmlFor="BornYear"
              onChange={this.handleSignUpValue("bornYear")}
            >
              <div>출생년도</div>
